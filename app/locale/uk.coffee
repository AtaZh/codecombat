module.exports = nativeDescription: "Українська", englishDescription: "Ukrainian", translation:
  ...
  play:
    ...
    subscriber_heroes: "Підпишіться сьогодні, щоб одразу розблокувати Amara, Hushbaum та Hattori!"
    ...
    brain_pop_challenge: "Киньте собі виклик, спробувавши пограти іншою мовою програмування!"
    replay: "Повторити"
    back_to_classroom: "Повернутися у клас"
  ...
  signup:
    ...
    teacher_students_can_start_now: "Ваші студенти одразу зможуть почати грати перший курс, «Вступ до комп\'ютерних наук»."
    teacher_list_create_class: "На наступному екрані Ви зможете створити новий клас."
    teacher_list_add_students: "Додавайте студентів до класу, натиснувши на посилання «Переглянути клас», а тоді надіславши студентам код або URL. Ви можете запросити їх електронною поштою, якщо у них є email-адреси."
    teacher_list_resource_hub_1: "Ознайомтеся: "
    teacher_list_resource_hub_2: "Посібник курсів"
    teacher_list_resource_hub_3: "містить рішення кожного рівня, "
    teacher_list_resource_hub_4: "Ресурсний хаб"
    teacher_list_resource_hub_5: "має настанови про розклад, заняття та багато іншого!"
    teacher_additional_questions: "Ось і все! Якщо Вам знадобиться допомога або з\'являться запитання, напишіть на __supportEmail__."
    dont_use_our_email_silly: "Не пишіть тут нашу електронну пошту! Напишіть email Ваших батьків."
  ...
  earn_gems:
    prompt_title: "Не достатньо самоцвітів"
  ...
  announcement:
    now_available: "Тепер доступне підписникам!"
    subscriber: "підписник"
    cuddly_companions: "Привабливі компаньйони!" # Pet Announcement Modal
    kindling_name: "Запальний елементаль"
    kindling_description: "Запальні елементалі просто хочуть зігріти Вас уночі. І вдень. Загалом, увесь час."
    griffin_name: "Маленький грифон"
    griffin_description: "Грифони — напіворли, напівлеви, на 100% чарівні."
    raven_name: "Ворон"
    raven_description: "Во́рони — неперевершені збиральники сяючих пляшечок зі здоров'ям."
    mimic_name: "Імітатор"
    mimic_description: "Імітатори можуть підбирати для Вас монети. Перемістіть їх угору монет, щоб покращити їх виробництво."
    cougar_name: "Кугуар"
    cougar_description: "Кугуари люблять ставати КМС завдяки Котячому Муркотінню Спозаранку."
    fox_name: "Синя лисиця"
    fox_description: "Сині лисиці дуже кмітливі і люблять копатися у грязюці і в снігу!!"
    pugicorn_name: "Мопсоріг"
    pugicorn_description: "Мопсороги — одні з найрідкісніших створіть, і вони можуть чаклувати!!"
    wolf_name: "Вовченя"
    wolf_description: "Вовченята прекрасно полюють, збирають і нечемно граються в хованки!"
    ball_name: "Червоний писклявий клубочок"
    ball_description: "ball.squeak()"
    collect_pets: "Зберіть улюбленців своїм героям!"
    each_pet: "Кожен улюбленець має унікальну помічну властивість!"
    upgrade_to_premium: "Станьте {{subscriber}}ом, щоб могти споряджати улюбленців."
    play_second_kithmaze: "Пройдіть {{the_second_kithmaze}}, щоб to розблокувати Вовченя!"
    the_second_kithmaze: "Другий лабіринт"
    keep_playing: "Продовжуйте грати, щоб отримати першого улюбленця!"
    coming_soon: "Скоро буде"
    ritic: "Рітік Холодний" # Ritic Announcement Modal
    ritic_description: "Рітік Холодний. Після нескінченних століть у пастці льодовика Кельвінтафія, він нарешті вільний і рветься на оґрів, що його ув\'язнили."
    ice_block: "Блок льоду"
    ice_description: "Там щось є всередині…"
    blink_name: "Кліп"
    blink_description: "Рітік зникає і з\'являється, поки кліпне око, не залишаючи нічого, крім тіні."
    shadowStep_name: "Тінь"
    shadowStep_description: "Бездоганний асасин, який знає, як пройти поміж тінями."
    tornado_name: "Торнадо"
    tornado_description: "Добре мати кнопку перезапуску, коли твоє прикриття здуло."
    wallOfDarkness_name: "Стіна темряви"
    wallOfDarkness_description: "Сховайся за стіною тіней від пильного погляду цікавих очей."
  ...
  premium_features:
    ...
    hero_blurb_1: "Отримайте доступ до __premiumHeroesCount__ суперзаряджених героїв лише для передплатників! Приручіть нестримну силу Окара Тупотонога, смертельну точність Лісової Нарії або приручіть «милі» скелети з Нальфаром Криптором."
    hero_blurb_2: "Преміум-воїни розблоковують такі неймовірні бойові мистецтва як бойовий клич, тупотіння і кидання противником. Або ж зіграйте як Рейнджер, використовуючи хитрість і лук, метання ножів і пастки! Випробуйте свої вміння у ролі справжнього Чарівника коду і випустіть на волю сильну первісну, некромантську чи елементальну магію!"
    hero_caption: "Нові вражаючі герої!"
    pet_blurb_1: "Улюбленці — це не просто милі компаньйони, вони також додають унікальні фукнції і засоби. Малюк-грифон може перелітати через перешкоди, допомагаючи герою, Вовченя може ловити зілля, а Кугуар вміє розмовляти!"
    pet_blurb_2: "Зберіть усіх улюбленців і відкрийте їхні унікальні здібності!"
    pet_caption: "Візьміть улюбленців для компанії своєму герою!"
    game_dev_blurb: "Вивчіть будову гри і побудуйте нові рівні, якими діліться з друзями! Розмістіть бажані предмети, напишіть код для логіки і поведінки об'єкта, і подивіться, чи Ваші друзі зможуть пройти рівень!"
    ...
    list_items: "Отримуйте преміум-предмети на зразок улюбленців"
  ...
  about:
    ...
    jobs_benefit_6: "Медична страховка (gold), дантист, окуліст; доїзд"
    jobs_benefit_7: "Сидячо-стоячі столи для всіх"
    jobs_benefit_9: "10-річний термін реалізації опціонів"
  ...
  teachers_quote:
    ...
    advisor: "Спеціаліст/радник з розкладу"
    principal: "Директор"
    superintendent: "Завуч"
    parent: "Батьки"
  ...
  courses:
    ...
    unsubscribe_warning: "Увага: Вашу щомісячну підписку буде скасовано."
  ...
  teacher:
    ...
    license_remaining: "ліцензія залишилася"
    licenses_remaining: "ліцензії/й залишилося"
    one_license_used: "1 ліцензію було використано"
    num_licenses_used: "__numLicensesUsed__ ліцензії/й використано"
    ...
    arenas_curriculum_desc: "Інструкції, як запустити арени Wakka Maul, Cross Bones та Power Peak для багатьох гравців у своєму класі."
    ...
    cs5_curriculum_js: "Комп'ютерні науки 5 - Навчальний план (JavaScript)"
    cs5_curriculum_desc_js: "Обсяг і послідовність, плани уроків, вправи та інше для Курсу 5 з використанням JavaScript."
    cs5_curriculum_py: "Комп'ютерні науки 5 - Навчальний план (Python)"
    cs5_curriculum_desc_py: "Обсяг і послідовність, плани уроків, вправи та інше для Курсу Course 5 з використанням Python."
    ...
    gd1: "Розробка ігор 1"
    gd1_guide: "Розробка ігор 1 - Посібник проекту"
    gd1_guide_desc: "Скористайтеся нам, щоб допомогти своїм студентам, поки вони створюють свій перший проект гри за 5 днів."
    wd1: "Веб розробка 1"
    ...
    unused_licenses: "У Вас є невикористані ліцензії, за якими можна записувати студентів до платних курсів, коли вони готові дізнатися більше!"
    remember_new_courses: "Не забудьте задати нові курси!"
    more_info: "Детальніше"
    how_to_assign_courses: "Як задати курси"
    select_students: "Оберіть студентів"
    select_instructions: "Поставте галочку поруч з кожним студентом/кою, яким Ви хочете задати курс."
    choose_course: "Оберіть курс"
    choose_instructions: "Виберіть з випадного меню курс, який би Ви хотіли задати, тоді натисніть «Задати обраним студентам»."
    push_projects: "Ми рекомендуємо задати Веб-розробку 1 або Розробку ігор 1 після того, як студенти пройдуть Вступ до комп\'ютерних наук! Див. {{resource_hub}}, де є більше інформації про ці курси."
    teacher_quest: "Квест успіху вчителя"
    quests_complete: "Пройдені квести"
    teacher_quest_create_classroom: "Створити клас"
    teacher_quest_add_students: "Додати студентів"
    teacher_quest_teach_methods: "Допомогти студентам опанувати «методи виклику»."
    teacher_quest_teach_methods_step1: "75% принаймні одного класу, які пройшли перший рівень, __Dungeons of Kithgard__"
    teacher_quest_teach_methods_step2: "Роздрукувати [Ввідний посібник учня](http://files.codecombat.com/docs/resources/StudentQuickStartGuide.pdf) у Ресурсному хабі."
    teacher_quest_teach_strings: "Не шикуйте студентів по струнці, навчіть їх «strings»."
    teacher_quest_teach_strings_step1: "75% принаймні одного класу пройшли __True Names__"
